...
export default function NousRejoindre() {
  ...
  const [hasOffers] = useState(false); // Mettez à true si vous avez des offres actives *TRES IMPORTANT*
          ...
          {hasOffers ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <Card className="shadow-md">
                ...
                <CardFooter>
                  <Button 
                    onClick={() => handleApplyClick("Comptable confirmé(e)")}
                    className="w-full"
                  >
              ...
              <Card className="shadow-md">
                ...
                <CardFooter>
                  <Button 
                    onClick={() => handleApplyClick("Assistant(e) comptable")}
                    className="w-full"
                  >
                    Postuler maintenant <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
      ...
      <section id="postuler" className="py-20 scroll-mt-20">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <Tabs defaultValue={hasOffers ? "offres" : "spontanee"} className="w-full mb-12">
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="offres" disabled={!hasOffers}>
                  Postuler à une offre
                </TabsTrigger>
                <TabsTrigger value="spontanee">
